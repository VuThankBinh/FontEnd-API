...
var Gmin = timGiaMin(sanpham.GiayBongRo[0].Giay_Tre_Em), Gmax = timGiaMax(sanpham.GiayBongRo[0].Giay_Tre_Em);
...
function chonSX(min,max){
  ...
  console.log(sx);
  if(sx=="Tang"){
    sxloai_tang(sanpham.GiayBongRo[0].Giay_Tre_Em,min,max)
  }
  if(sx=="Giam"){
    sxloai_giam(sanpham.GiayBongRo[0].Giay_Tre_Em,min,max)
  }
}
